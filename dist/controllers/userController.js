    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          console.error("Get profile error:", _context.t0);
          res.status(500).json({
...
var updateUserProfile = exports.updateUserProfile = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, fullname, password, profilepic, user, updateFields, imageUrl, salt, updatedUser;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _req$body = req.body, fullname = _req$body.fullname, password = _req$body.password;
        ...
        case 6:
          ...
          _context2.next = 15;
          return (0, _cloudinary.uploadToCloudinary)(profilepic);
        case 15:
        ...
        case 20:
          ...
          console.error('Cloudinary upload error:', _context2.t0);
        ...
        case 30:
          updateFields.password = _context2.sent;
        case 31:
          _context2.next = 33;
        ...
        case 38:
          ...
          console.error("Update profile error:", _context2.t1);
          res.status(500).json({
            success: false,
