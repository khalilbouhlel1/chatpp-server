...
var _validateEnv = require("../configs/validateEnv.js");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          _socket.app.use((0, _cors["default"])(corsOptions));
          _socket.app.use((0, _cookieParser["default"])());
          _socket.app.use(_security.securityMiddleware);
          _socket.app.use(_express["default"].json({
            limit: '10mb'
          }));
          _socket.app.use(_express["default"].urlencoded({
            extended: true,
            limit: '10mb'
          }));
          ...
          // Routes
          _socket.app.get("/health", function (req, res) {
            res.send({
              message: "health OK!"
            });
          });
          _socket.app.use("/api/auth", _authRoutes["default"]);
          _socket.app.use("/api/profile", _userRoutes["default"]);
          _socket.app.use("/api/messages", _messageRoutes["default"]);
          _socket.app.use(_errorHandler.errorHandler);

          // Serve static files in production
          if (process.env.NODE_ENV === 'production') {
            _socket.app.use(_express["default"]["static"](_path["default"].join(__dirname, '../../client/dist')));
        ...
        case 21:
          ...
          console.error('Failed to start server:', _context.t0);
          process.exit(1);
        case 25:
        case "end":
